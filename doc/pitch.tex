...
\comment{The objective of this assignment is the analysis of basic properties of the speech signal: voicing and pith, and to develop accurate estimation algorithms of these parameters.}
